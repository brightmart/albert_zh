    ...
    if i == len(document) - 1 or current_length >= target_seq_length:
      ...
      if current_chunk: # 如果当前块不为空
        ...
        if rng.random() < 0.5: # 交换一下tokens_a和tokens_b
          ...
          print("tokens_a length2.r:", len(tokens_a))
          print("tokens_b length2.r:", len(tokens_b))
        else:
          print("tokens_a length2.not r:", len(tokens_a))
          print("tokens_b length2.not r:", len(tokens_b))
